...
const Dashboard = () => {
    ...
    const handleRechargeCredit = () => {
        Linking.openURL('http://192.168.5.172:3000');
    };
    ...
    return (
        <SafeAreaView style={styles.container}>
            ...
            <TouchableOpacity
                onPress={handleRechargeCredit}
                style={styles.button}
            >
                <Text style={styles.buttonText}>Recharger votre crédit</Text>
            </TouchableOpacity>
