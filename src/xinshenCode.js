...
export default function App() {
  ...
  if (!permission.granted) {
    ...
    return (
      <View style={styles.container}>
        <Text style={{ textAlign: 'center' }}>L'accès à la caméra est nécessaire pour utiliser cette fonctionnalité</Text>
  ...
  return (
    <View style={styles.container}>
      <CameraView style={styles.camera} facing={facing} onBarCodeScanned={scanned ? undefined : handleBarCodeScanned} style={StyleSheet.absoluteFillObject} />
      {scanned && (
        <View>
